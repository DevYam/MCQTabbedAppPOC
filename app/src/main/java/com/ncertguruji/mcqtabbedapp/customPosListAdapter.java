...
public class customPosListAdapter extends ArrayAdapter {
    private final String[] chapterName;
    private final String[] chapterDescription;
    private final Integer[] imageId;
    private final Activity context;

    public customPosListAdapter(Activity context, String[] chapterName, String[] chapterDescription, Integer[] imageId) {
